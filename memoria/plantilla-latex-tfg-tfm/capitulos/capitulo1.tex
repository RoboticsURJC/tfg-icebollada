...
\begin{figure}[h!]
  \begin{center}
    \subfigure[Coche autónomo de Google]{\includegraphics[width=7.5cm]{figs/coche}}
    \subfigure[Vision de un Tesla autónomo]{\includegraphics[width=7.5cm]{figs/coche_autonomo}}
  \end{center}
...
\begin{figure}[h!]
  \begin{center}
    \subfigure[Clasificación]{\includegraphics[width=43mm]{figs/clasificacion}}\hspace{8mm}
