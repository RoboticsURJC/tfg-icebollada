...
La observación de estos animales en todo momento es una necesidad para analizar y estudiar su comportamiento, así como tener la información de las condiciones del entorno a las que se encuentran, haciendo necesario que haya trabajadores analizando las condiciones y grabaciones que tienen que hacerse a los ratones todos los días. Para evitar esto, el fin de este trabajo es crear un sistema sensorial que proporcione la monitorización del entorno fácilmente comprensible para el trabajador y que ese mismo sistema sea capaz poder detectar los comportamientos de los ratones en una plataforma económicamente accesible para todo el mundo. \\

Durante todo el desarrollo del trabajo han surgido problemas en conexiones, seguridad, instalación, en el uso de algunos sensores y el uso de herramientas no usadas hasta el momento debido al desconocimiento. Tras el estudio y la comprensión de los errores encontrados, así como con la ayuda de internet y de las experiencias de otros usuarios, tanto con problemas similares como con posibles soluciones, todos los errores han podido solucionarse.
